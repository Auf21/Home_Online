...
<head>
    ...
    <!-- for landing -->
    <link rel="stylesheet" href="css/addland.css">
    <!-- font -->
...
<body>
    ...
    <div class="head bg-white p-15 between-flex">
     ...
     <div class="landing1">
        ...
        <div class="text">
            <div class="contant">
                <h2>هوم أونلاين !<br>نحن نساعدك على أرضك بسرعة اكبر.</h2>
     ...
     <div class="contant">
        <div class="contener">
            <div class="address">
                ...
                <p>أدخل عنوان الأرض:</p>
                      <form action="{{route('storeland')}}" method="POST" enctype="multipart/form-data">
                        @CSRF
                        <label for=""></label>
                        <div>
                        ...
                        <div class="price">
                            ...
                            <label for="">نوع الأرض</label>
                            <select name="type" class="edit" id="">
                                <option value="أرض صالحة للزراعة ( تربة حمراء )">  أرض صالحة للزراعة ( تربة حمراء )  </option>
                                <option value="أرض تربة صخرية">أرض تربة صخرية</option>
                                <option value="أرض تربة رملية">أرض تربة رملية</option>
                            </select>
                        </div>
                        <div>
